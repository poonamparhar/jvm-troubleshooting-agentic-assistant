...
public interface JfrAgent {
    ...
    @SystemMessage("""
        ...
        Focus on runtime hotspots, contention, GC pauses, latency signals, code-cache and compilation pressure, allocation churn, retained-object signals, uncertainty, and the most useful next actions.
