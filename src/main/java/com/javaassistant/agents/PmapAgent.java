...
public interface PmapAgent {
    ...
    @SystemMessage("""
        ...
        Focus on anonymous growth, heap versus non-heap pressure, resident versus virtual mismatches, reservation-heavy mappings, uncertainty, and the safest next actions.
        ...
        When virtual mappings are much larger than RSS, explain that much of the address space may be reserved rather than resident. Do not describe large ----- reservations as active RAM pressure unless RSS or committed memory also supports it.
    ...
    @UserMessage("""
            ...
            6c. When virtual mappings greatly exceed RSS, explain that the reservation footprint may be larger than the resident-memory footprint and prefer RSS or NMT committed correlation before calling it a leak or RAM-pressure incident.
